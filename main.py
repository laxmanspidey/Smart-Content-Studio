...
with col1:
    st.markdown(
        '<img src="https://media.gettyimages.com/id/1436216218/video/social-media-chart-inside.jpg?s=640x640&k=20&c=3ym3s242m6JdsSPaKDt0UZuKGlVmp_CVQrYm1B434Pw=" class="half-width-image">',
        unsafe_allow_html=True,
    )
